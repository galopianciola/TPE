...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		ColaMultiple colaAzar1 = new ColaMultiple();
		//colaAzar1.setEstrategia(new Azar());
		...
		ColaMultiple colaIntercalado1 = new ColaMultiple();
		//colaIntercalado1.setEstrategia(new Intercalado());
		...
		ColaMultiple colaAzar2 = new ColaMultiple();
		//colaAzar2.setEstrategia(new Azar());
		colaAzar2.agregarCola(cola5);
		colaAzar2.agregarCola(cola6);
		
		ColaMultiple colaAzar3 = new ColaMultiple();
		//colaAzar3.setEstrategia(new Azar());
		colaAzar3.agregarCola(colaIntercalado1);
		colaAzar3.agregarCola(colaAzar2);
		
		///////////
		
		//colaAzar3.setEstrategia(new Intercalado());
		colaAzar3.agregar(new Integer(4));
